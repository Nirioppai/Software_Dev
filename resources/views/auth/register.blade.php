      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-md-7 ">
            ...
            <div class="md-form mt--1">
                ...
                @endif
                <label for="materialLoginFormName"><i class="fas fa-id-card-alt"></i> <small>Name</small></label>
            </div>
            ...
            <div class="md-form mt--1">
                ...
                @endif
                <label for="materialLoginFormUsername"><i class="ni ni-lock-circle-open"></i> <small>Username</small></label>
            </div>
            ...
            <div class="md-form mt--1">
                ...
                <label for="materialLoginFormPassword"><i class="ni ni-lock-circle-open"></i> <small>Confirm Password</small></label>
            </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              © 2020 <a href="#" class="font-weight-bold ml-1 text-white" target="_blank">Radisoft</a>
            </div>
          </div>
          <div class="col-xl-6">
