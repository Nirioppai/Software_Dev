...
class CreateBatchedStudentDatasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('batched_student_datas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('batched_student_datas');
    }
}
