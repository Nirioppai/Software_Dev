...
@section('title')
<title>OLSAT | Upload Reference - Scaled Score to School Ability Index (SAI)</title>
@endsection
...
<div>
    ...
    <a class="current-breadcrumb text-dark"><b>Scaled Score to School Ability Index (SAI)</b></a>
</div>
@endsection
                    ...
                    <!-- Form open here -->
                      ...
                      <div class="input-group down ml-5 col-sm-6 ">
                          ...
                          <div class="custom-file down">
                            <form method="POST" action="{{ route('selectiveSAIAdd2') }}" enctype="multipart/form-data">
                              {{ csrf_field() }}
...
@if($uploader == 'sai_2')
                    ...
                    <form method="POST" action="{{ route('selectiveSAIAdd3') }}">
                    {{ csrf_field() }}
...
@if($uploader == 'sai_3')
                    <div class="step-content grey lighten-3">
                        <p>Finalize <b>Scaled Score to School Ability Index (SAI)</b> uploading?</p>
                    </div>
