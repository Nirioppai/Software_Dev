...
@section('content')
  ...
  <div class="col">
      ...
      <div class="row-md-8">
        ...
        <form action="{{ route('monitoring_nonverbal') }}" method="get">
          {{ csrf_field() }}

        <div class="input-group">
             <input type="text" name="search" id="search" placeholder="Search in Non-Verbal" value="{{$input_search}}" aria-describedby="button-addon8" class="form-control">
            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="th-lg"><a href="">Non-Verbal Raw Score<i class="fas fa-sort ml-1"></a></i></th>
                  <th class="th-lg"><a href="">Non-Verbal Scaled Score<i class="fas fa-sort ml-1"></a></i></th>
                  <th class="th-lg"><a href="">Non-Verbal SAI<i class="fas fa-sort ml-1"></a></i></th>
                  <th class="th-lg"><a href="">Non-Verbal Percentile Rank<i class="fas fa-sort ml-1"></a></i></th>
                  <th class="th-lg"><a href="">Non-Verbal Stanine<i class="fas fa-sort ml-1"></a></i></th>
...
<!-- @section('monitoring_nonverbal')
  ...
  <script>
    ...
    $(document).ready(function(){
     ...
     {
      $.ajax({
       url:"/monitoring/nonverbal/fetch_data?page="+page+"&query="+query,
