...
@section('content')
    ...
    <h2>Non Verbal Raw Score</h2> <p>{{$non_verbal_score_details->total_raw_score}}</p>
    <h2>Non Verbal Scaled Score</h2> <p>{{$non_verbal_score_details->total_scaled_score}}</p>
    <h2>Non Verbal SAI</h2> <p>{{$non_verbal_score_details->total_sai}}</p>
    <h2>Non Verbal Percentile Rank</h2> <p>{{$non_verbal_score_details->total_percentile_rank}}</p>
    <h2>Non Verbal Stanine</h2> <p>{{$non_verbal_score_details->total_stanine}}</p>
