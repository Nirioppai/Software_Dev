        ...
        create view `student_result_total` as
              (
                ...
                From
                    ...
                    Inner Join
                    olsat.scaled_to_sai_total On olsat.scaled_to_sai_total.gradescore = olsat.raw_to_scaled_total.scaledscore
                            And olsat.scaled_to_sai_total.age = olsat.final_student_datas.rounded_current_age_in_years
