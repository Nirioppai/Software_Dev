...
@section('title')
<title>OLSAT | Verbal Score Info</title>
@endsection
            ...
            <div class="card-body pt-0 pt-md-4">
                <div class="text-center mt-5">
                    ...
                    <div class="text-left">
                        ...
                        <span class="font-weight-bold">Student No:</span> <span class="ml-1">{{$verbal_score_details->student_id}}</span>
                        <br>
